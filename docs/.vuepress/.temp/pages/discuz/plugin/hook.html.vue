<template><div><h1 id="页面嵌入" tabindex="-1"><a class="header-anchor" href="#页面嵌入"><span>页面嵌入</span></a></h1>
<h2 id="页面嵌入类型脚本格式" tabindex="-1"><a class="header-anchor" href="#页面嵌入类型脚本格式"><span>页面嵌入类型脚本格式</span></a></h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="plugin" tabindex="-1"><a class="header-anchor" href="#plugin"><span>plugin_</span></a></h3>
<blockquote>
<p>普通版脚本中的类名以 <code v-pre>plugin_</code> 开头。手机版脚本中的类名以 mobileplugin_ 开头。</p>
</blockquote>
<h3 id="identifier" tabindex="-1"><a class="header-anchor" href="#identifier"><span>identifier</span></a></h3>
<blockquote>
<p>插件的唯一标识符，在插件设置中设置。</p>
</blockquote>
<h3 id="curscript" tabindex="-1"><a class="header-anchor" href="#curscript"><span>CURSCRIPT</span></a></h3>
<blockquote>
<p>嵌入点位于的脚本名，如 forum.php 为 forum。</p>
</blockquote>
<p>X3.4 最新版本开始支持plugin.php为CURSCRIPT的插件之间的hook调用，CURSCRIPT值为plugin。New!</p>
<h3 id="hookid" tabindex="-1"><a class="header-anchor" href="#hookid"><span>HookId</span></a></h3>
<table>
<thead>
<tr>
<th>函数名</th>
...
<tr>
<td>HookId_output($value)</td>
<td>模块执行完毕，模板输出前被调用</td>
<td>脚本嵌入点类</td>
<td>$value: array(  <br>‘template’ =&gt; 当前要输出的模版,  <br>‘message’ =&gt; showmessage 的信息内容,  <br>‘values’ =&gt; showmessage 的信息变量,  <br>)</td>
</tr>
<tr>
<td>global_HookId()</td>
<td>模块执行完毕，模板输出前被调用</td>
...
<tr>
<td>HookId_message($value)</td>
<td>showmessage() 执行时调用</td>
<td>脚本嵌入点类</td>
<td>$value: array(  <br>‘param’ =&gt; showmessage() 函数的参数数组,  <br>)</td>
</tr>
<tr>
<td>ad_adId($value)</td>
<td>相应的广告位中调用  <br>函数名为广告位脚本 ID  <br>如：ad_headerbanner()</td>
<td>全局嵌入点类  <br>脚本嵌入点类</td>
<td>&gt;$value: array(  <br>‘params’ =&gt; 广告位参数,  <br>‘content’ =&gt; 当前广告位原本将要显示的内容,  <br>)</td>
</tr>
<tr>
<td>common()</td>
<td>所有模块执行前被调用</td>
...
<tr>
<td>discuzcode($value)</td>
<td>discuzcode() 函数执行时调用  <br>用于在帖子内容解析时嵌入自己的功能，函数中 <code v-pre>$_G['discuzcodemessage']</code> 变量为待解析的字串</td>
<td>全局嵌入点类</td>
<td>$value: array(  <br>‘param’ =&gt; caller 函数的参数数组,  <br>‘caller’ =&gt; caller 函数，此嵌入点被哪个函数调用  <br>‘discuzcode’ 被 discuzcode() 调用  <br>‘messagecutstr’ 被 messagecutstr() 调用  <br>)</td>
</tr>
<tr>
<td>deletethread($value)</td>
<td>deletethread() 函数执行时调用  <br>用于在主题删除前后嵌入自己的功能，此函数将在 deletethread() 中被调用 2 次，函数中 <code v-pre>$_G['deletethreadtids']</code> 变量为待处理的 TID 数组</td>
<td>全局嵌入点类</td>
<td>$value: array(  <br>‘param’ =&gt; deletethread() 函数的参数数组,  <br>‘step’ =&gt; 删除的步骤  <br>‘check’ 检测步骤  <br>‘delete’ 删除步骤  <br>)</td>
</tr>
<tr>
<td>deletepost($value)</td>
<td>deletepost() 函数执行时调用  <br>用于在帖子删除前后嵌入自己的功能，此函数将在 deletepost() 中被调用 2 次，函数中 <code v-pre>$_G['deletepostids']</code> 变量为待处理的 ID 数组</td>
<td>全局嵌入点类</td>
<td>$value: array(  <br>‘param’ =&gt; deletepost() 函数的参数数组,  <br>‘step’ =&gt; 删除的步骤  <br>‘check’ 检测步骤  <br>‘delete’ 删除步骤  <br>)</td>
</tr>
<tr>
<td>avatar($value)  <br>(X2.5 新增)</td>
<td>avatar() 函数执行时调用  <br>用于在头像调用时嵌入自己的功能，函数中 <code v-pre>$_G['hookavatar']</code> 变量为新头像返回值</td>
<td>全局嵌入点类</td>
<td>$value: array(  <br>‘param’ =&gt; avatar() 函数的参数数组  <br>)</td>
</tr>
<tr>
<td>profile_node($post, $start, $end)  <br>(X3.0 新增)</td>
<td>贴内用户信息标记，返回值为标记显示内容</td>
<td>全局嵌入点类</td>
<td>$post: 当前帖子信息数组  <br>$start: 用户填写的前置字符  <br>$end: 用户填写的后置字符</td>
</tr>
<tr>
<td>identifier__hookid(_output)()  <br>(X3.4 新增New!)</td>
<td>插件的hook调用  <br>identifier为输出对象的应用ID，hookid为输出对象应用自定义的hook名称  <br>其他使用方法参考HookId()以及HookId_output($value)</td>
<td>脚本嵌入点类  <br>应用互动嵌入点类</td>
<td>参数含义</td>
</tr>
</tbody>
</table>
<blockquote>
<p>要查看所有的预定义嵌入点，请打开 config/config_global.php 文件，将文件结尾添加的设计者模式值改成“2”，然后更新缓存即可。在页面源码中查找<code v-pre>&lt;hook&gt;</code>可搜索到嵌入点。（详细内容可参阅的《<a href="https://open.dismall.com/?ac=document&amp;page=plugin_hooklist" target="_blank" rel="noopener noreferrer">插件嵌入点列表<ExternalLinkIcon/></a>》）</p>
</blockquote>
<div class="language-php line-numbers-mode" data-ext="php" data-title="php"><pre v-pre class="language-php"><code><span class="token variable">$_config</span><span class="token punctuation">[</span><span class="token string single-quoted-string">'plugindeveloper'</span><span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token number">2</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p>预定义的嵌入点会在页面预置好的位置输出函数返回的内容。函数返回值类型如果是 array 且是空值的，必须输出一个空数组，如：</p>
</blockquote>
<div class="language-php line-numbers-mode" data-ext="php" data-title="php"><pre v-pre class="language-php"><code><span class="token keyword">return</span> <span class="token keyword">array</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p>函数名并不限于以上列表，您可以自定义，只要符合以下规则，函数就会在适当的地方被调用。</p>
</blockquote>
<div class="language-php line-numbers-mode" data-ext="php" data-title="php"><pre v-pre class="language-php"><code><span class="token keyword">function</span> <span class="token constant">CURMODULE_USERDEFINE</span><span class="token punctuation">[</span>_output<span class="token punctuation">]</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p>CURMODULE 指明了此函数在哪个模块执行，可通过常量 CURMODULE 得到当前页面的 CURMODULE 值。<br>
USERDEFINE 可自定义，如果函数名以“_output”结尾则会在模板输出前调用，否则会在模块执行前调用。</p>
</blockquote>
<p>如：attachment_test() 函数会在论坛的下载附件的时候执行。</p>
<blockquote>
<p>“_output”结尾的函数的第一个参数为数组，含义为 array(‘template’ =&gt; 要输出的模板名, ‘message’ =&gt; showmessage 的文字)</p>
</blockquote>
<p>如：以下函数将在登录的时候输出调试文字</p>
<div class="language-php line-numbers-mode" data-ext="php" data-title="php"><pre v-pre class="language-php"><code><span class="token keyword">function</span> <span class="token function-definition function">logging_test_output</span><span class="token punctuation">(</span><span class="token variable">$a</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>plugin_identifier 类中的其它函数为了便于阅读建议以“_”开头，如：</p>
<div class="language-php line-numbers-mode" data-ext="php" data-title="php"><pre v-pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
...
<span class="token punctuation">}</span>
<span class="token delimiter important">?></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="插件嵌入点列表" tabindex="-1"><a class="header-anchor" href="#插件嵌入点列表"><span>插件嵌入点列表</span></a></h2>
<h3 id="全局-common" tabindex="-1"><a class="header-anchor" href="#全局-common"><span>全局(common/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>extcredits.htm
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="论坛-forum" tabindex="-1"><a class="header-anchor" href="#论坛-forum"><span>论坛(forum/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>collection_all.htm (X2.5)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="群组-group" tabindex="-1"><a class="header-anchor" href="#群组-group"><span>群组(group/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>group.htm
...
type.htm
   ...
   string index_side_top
   string index_side_bottom
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="家园-home" tabindex="-1"><a class="header-anchor" href="#家园-home"><span>家园(home/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>editor_image_menu.htm (X3)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="注册-登录-member" tabindex="-1"><a class="header-anchor" href="#注册-登录-member"><span>注册/登录(member/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>login.htm
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="门户-portal" tabindex="-1"><a class="header-anchor" href="#门户-portal"><span>门户(portal/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>portalcp_article.htm
   string portalcp_top
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="排行榜-ranklist" tabindex="-1"><a class="header-anchor" href="#排行榜-ranklist"><span>排行榜(ranklist/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>side_left.htm
   string ranklist_nav_extra
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="搜索-search" tabindex="-1"><a class="header-anchor" href="#搜索-search"><span>搜索(search/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>album.htm
   string album_top
   string album_bottom
blog.htm
   string blog_top
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="应用-userapp" tabindex="-1"><a class="header-anchor" href="#应用-userapp"><span>应用(userapp/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>userapp_app.htm
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="手机标准版-mobile-common" tabindex="-1"><a class="header-anchor" href="#手机标准版-mobile-common"><span>手机标准版(mobile/common/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>footer.htm
   string global_footer_mobile
header.htm
   string global_header_mobile
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="手机标准版-mobile-forum" tabindex="-1"><a class="header-anchor" href="#手机标准版-mobile-forum"><span>手机标准版(mobile/forum/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>discuz.htm
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="手机触屏版-touch-common" tabindex="-1"><a class="header-anchor" href="#手机触屏版-touch-common"><span>手机触屏版(touch/common/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>footer.htm
    string global_footer_mobile
header.htm
    string global_header_mobile
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="手机触屏版-touch-forum" tabindex="-1"><a class="header-anchor" href="#手机触屏版-touch-forum"><span>手机触屏版(touch/forum/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>discuz.htm
    string index_top_mobile
    string index_middle_mobile
forumdisplay.htm
...
viewthread.htm
    ...
    array viewthread_postbottom_mobile
    string viewthread_bottom_mobile
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="手机触屏版-touch-member" tabindex="-1"><a class="header-anchor" href="#手机触屏版-touch-member"><span>手机触屏版(touch/member/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>login.htm
    string logging_bottom_mobile (X3.1)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="手机极简版-wml-forum" tabindex="-1"><a class="header-anchor" href="#手机极简版-wml-forum"><span>手机极简版(wml/forum/)</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>discuz.htm
   string index_top_mobile
   string index_middle_mobile
forumdisplay.htm
